...
import fundrequestpresale_artifacts from '../../build/contracts/FundRequestPreSale.json'

// MetaCoin is our usable abstraction, which we'll use through the code below.
var FundRequestPreSale = contract(fundrequestpresale_artifacts);
...
window.App = {
  start: function() {
    ...
    FundRequestPreSale.setProvider(web3.currentProvider);
